	...
	final class WPSC_Functions {
		...
		public static function date_interval_highest_unit_ago( $diff ) {
			...
			if ( $diff->i ) {
				return sprintf(
					/* translators: %d: number of minutes */
					__( '%d minutos atrás', 'supportcandy' ),
			...
			if ( $diff->s ) {
				return sprintf(
					...
					__( '%d segundos atrás', 'supportcandy' ),
