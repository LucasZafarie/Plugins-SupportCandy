				...
				<div class="wpsc-dash-widget-header">
					...
					<div class="wpsc-dash-widget-actions">
						<div class="ticket-info-container">
							<div><?php esc_attr_e( 'Ocorrências criadas', 'supportcandy' ); ?>: <span class="tickets-created"></span></div>
							<div><?php esc_attr_e( 'Ocorrências fechadas', 'supportcandy' ); ?>: <span class="tickets-closed"></span></div>
							<select name="" class="select-box" id="date_wise_ts_report" onchange="wpsc_get_dbw_ticket_statistics();">
								<option <?php selected( $db_gs['default-date-range'], 'today' ); ?> value="today"><?php esc_attr_e( 'Hoje', 'supportcandy' ); ?></option>
								<option <?php selected( $db_gs['default-date-range'], 'yesterday' ); ?> value="yesterday"><?php esc_attr_e( 'Ontem', 'supportcandy' ); ?></option>
								<option <?php selected( $db_gs['default-date-range'], 'this-week' ); ?> value="this-week"><?php esc_attr_e( 'Essa semana', 'supportcandy' ); ?></option>
								<option <?php selected( $db_gs['default-date-range'], 'last-week' ); ?> value="last-week"><?php esc_attr_e( 'Última semana', 'supportcandy' ); ?></option>
								<option <?php selected( $db_gs['default-date-range'], 'last-30-days' ); ?> value="last-30-days"><?php esc_attr_e( 'Últimos 30 dias', 'supportcandy' ); ?></option>
								<option <?php selected( $db_gs['default-date-range'], 'this-month' ); ?> value="this-month"><?php esc_attr_e( 'Esse mês', 'supportcandy' ); ?></option>
								<option <?php selected( $db_gs['default-date-range'], 'last-month' ); ?> value="last-month"><?php esc_attr_e( 'Último mês', 'supportcandy' ); ?></option>
							</select>
						</div>
					</div>
				</div>
