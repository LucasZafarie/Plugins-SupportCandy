	...
	final class WPSC_DBW_Recent_Tickets {
				...
				<div class="wpsc-dash-widget-header">
					<div class="wpsc-dashboard-widget-icon-header">
						...
						<span>
							...
							echo "Ocorrências recentes";
							?>
						</span>
					</div>
					<div class="wpsc-dash-widget-actions">
						<a href="javascript:wpsc_get_ticket_list();"><?php echo esc_attr__( 'Ver todos', 'supportcandy' ); ?></a>
					</div>
				</div>
		...
		public static function recent_tickets_list() {
			...
			<table class="wpsc-recent-ticket-list">
				<thead>
					<th><?php esc_attr_e( 'Ocorrência', 'supportcandy' ); ?></th>
					<th><?php esc_attr_e( 'Status', 'supportcandy' ); ?></th>
					<th><?php esc_attr_e( 'Assunto', 'supportcandy' ); ?></th>
					<th><?php esc_attr_e( 'Atribuído', 'supportcandy' ); ?></th>
				</thead>
				<tbody>
					<?php
					if ( $tickets ) {
