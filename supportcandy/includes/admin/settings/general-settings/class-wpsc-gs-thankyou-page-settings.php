	...
	final class WPSC_GS_Thankyou_Page_Settings {
		...
		public static function load_settings_ui() {
			...
			<form action="#" onsubmit="return false;" class="wpsc-frm-gs-thankyoupage">
				...
				<h3><?php esc_attr_e( 'Agente', 'supportcandy' ); ?></h3>
					...
					<div class = "textarea-container ">
						<div class = "wpsc_tinymce_editor_btns">
							<div class="inner-container">
								...
								<button class="text wpsc-switch-editor wpsc-switch-editor-agent <?php echo $settings['editor-agent'] == 'text' ? 'active' : ''; ?>" type="button" onclick="wpsc_get_textarea(this, 'wpsc-html-agent')"><?php esc_attr_e( 'Texto', 'supportcandy' ); ?></button>
							</div>
						</div>
						<?php
						...
						<div class="wpsc-it-editor-action-container">
							<div class="actions">
								<div class="wpsc-editor-actions">
									<span class="wpsc-link" onclick="wpsc_get_macros()"><?php esc_attr_e( 'Inserir Macro', 'supportcandy' ); ?></span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="textarea-container">
						<div class="wpsc_tinymce_editor_btns">
							<div class="inner-container">
								...
								<button class="text wpsc-switch-editor wpsc-switch-editor-customer <?php echo $settings['editor-customer'] == 'text' ? 'active' : ''; ?>" type="button" onclick="wpsc_get_textarea(this, 'wpsc-html-customer')"><?php esc_attr_e( 'Texto', 'supportcandy' ); ?></button>
							</div>
						</div>
						<?php
