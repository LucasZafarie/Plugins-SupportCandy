...
if ( ! class_exists( 'WPSC_MS_GDPR' ) ) :
					...
					<div class="textarea-container ">
						<div class="wpsc_tinymce_editor_btns">
							<div class="inner-container">
								...
								<button class="text wpsc-switch-editor wpsc-switch-editor-ct <?php echo esc_attr( $settings['editor'] ) == 'text' ? 'active' : ''; ?>" type="button" onclick="wpsc_get_textarea(this, 'gdpr-text')"><?php esc_attr_e( 'Texto', 'supportcandy' ); ?></button>
							</div>
						</div>
						<?php
					...
					<div class="textarea-container ">
						<div class="wpsc_tinymce_editor_btns">
							<div class="inner-container">
								...
								<button class="text wpsc-switch-editor wpsc-switch-editor-reg-user <?php echo esc_attr( $settings['editor-reg-user'] ) == 'text' ? 'active' : ''; ?>" type="button" onclick="wpsc_get_textarea(this, 'gdpr-text-reg-user')"><?php esc_attr_e( 'Texto', 'supportcandy' ); ?></button>
							</div>
						</div>
						<?php
	...
	$name = "<p>Entendo que minhas informações pessoais como nome, endereço de e-mail, endereço IP, etc. serão armazenadas no banco de dados.</p>";						
?>
