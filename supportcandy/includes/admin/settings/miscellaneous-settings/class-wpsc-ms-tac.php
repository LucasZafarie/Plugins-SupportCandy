...
if ( ! class_exists( 'WPSC_MS_TAC' ) ) :
	...
	final class WPSC_MS_TAC {
		...
		public static function reset() {
			...
			$wpsc_tandc_text = '<p>Eu concordo com os Termos e Condições</p>';
					...
					<div class="textarea-container ">
						<div class="wpsc_tinymce_editor_btns">
							<div class="inner-container">
								...
								<button class="text wpsc-switch-editor wpsc-switch-editor-ct <?php echo esc_attr( $settings['editor'] ) == 'text' ? 'active' : ''; ?>" type="button" onclick="wpsc_get_textarea(this, 'tandc-text')"><?php esc_attr_e( 'Texto', 'supportcandy' ); ?></button>
							</div>
						</div>
						<?php
					...
					<div class="textarea-container ">
						<div class="wpsc_tinymce_editor_btns">
							<div class="inner-container">
								...
								<button class="text wpsc-switch-editor wpsc-switch-editor-reg-user <?php echo esc_attr( $settings['editor-reg-user'] ) == 'text' ? 'active' : ''; ?>" type="button" onclick="wpsc_get_textarea(this, 'tandc-text-reg-user')"><?php esc_attr_e( 'Texto', 'supportcandy' ); ?></button>
							</div>
						</div>
						<?php
	...
	$name = "<p>Eu concordo com os Termos e Condições</p>";						
?>
