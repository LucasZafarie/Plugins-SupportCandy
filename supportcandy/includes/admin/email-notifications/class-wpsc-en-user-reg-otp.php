	...
	final class WPSC_EN_User_Reg_OTP extends WPSC_Email_Notifications {
		...
		public static function reset() {
			...
			$user_otp = array(
				...
				'body'    => '<p>Olá {{firstname}},</p><p>Abaixo está sua senha única para registro de usuário:</p><p><strong>{{otp}}</strong></p>',
				'editor'  => 'html',
			);
		...
		public static function get_settings() {
			...
			<div class="wpsc-setting-header">
				<h2><?php esc_attr_e( 'Registro OTP', 'supportcandy' ); ?></h2>
			</div>
			<div class="wpsc-setting-section-body">
						...
						<div class="textarea-container ">
							<div class = "wpsc_tinymce_editor_btns">
								<div class="inner-container">
									...
									<button class="text wpsc-switch-editor <?php echo esc_attr( $settings['editor'] ) == 'text' ? 'active' : ''; ?>" type="button" onclick="wpsc_get_textarea(this, 'wpsc-en-body')"><?php esc_attr_e( 'Texto', 'supportcandy' ); ?></button>
								</div>
							</div>
							<?php
				...
				<div class="setting-footer-actions">
					...
					<button 
						...
						<?php esc_attr_e( 'Redefinir default', 'supportcandy' ); ?></button>
				</div>
			</div>
			<?php
			wp_die();
