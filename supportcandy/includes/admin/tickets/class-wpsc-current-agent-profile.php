		...
		public static function get_agent_profile() {
			...
			$menu_tabs = array(
				'general' => array(
					'slug'     => 'general',
					'icon'     => 'control',
					'label'    => esc_attr__( 'Configurações gerais', 'supportcandy' ),
			...
			<form class="wpsc-agent-settings" onsubmit="return false;" action="#">
				<div class="wpsc-tff wpsc-xs-12 wpsc-sm-12 wpsc-md-12 wpsc-lg-12">
					<div class="wpsc-tff-label">
						<span class="name"><?php esc_attr_e( 'Assinatura', 'supportcandy' ); ?></span>
					</div>
					<span class="extra-info"><?php esc_attr_e( 'Assinatura usada para e-mails', 'supportcandy' ); ?></span>
						...
						if ( $rich_editing ) {
							...
							<div class = "wpsc_tinymce_editor_btns">
								<div class="inner-container">
									...
									<button class="text wpsc-switch-editor <?php echo esc_attr( $editor ) == 'text' ? 'active' : ''; ?>" type="button" onclick="wpsc_get_textarea(this, 'signature-html')"><?php esc_attr_e( 'Texto', 'supportcandy' ); ?></button>
								</div>
							</div>
							<?php
						}
				...
				<div class="wpsc-tff wpsc-xs-12 wpsc-sm-12 wpsc-md-12 wpsc-lg-12">
					<div class="wpsc-tff-label">
						<span class="name"><?php esc_attr_e( 'Filtro padrão', 'supportcandy' ); ?></span>
					</div>
					<span class="extra-info"><?php esc_attr_e( 'Filtro padrão para a lista', 'supportcandy' ); ?></span>
				...
				<div class="wpsc-tff wpsc-xs-12 wpsc-sm-12 wpsc-md-12 wpsc-lg-12">
					<div class="wpsc-tff-label">
						<span class="name"><?php esc_attr_e( 'Aba padrão', 'supportcandy' ); ?></span>
					</div>
					<span class="extra-info"><?php esc_attr_e( 'Selecione a sessão padrão', 'supportcandy' ); ?></span>
					<select id="wpsc-dt" name="default-tab">
						...
						<option <?php selected( $tab, 'ticket-list' ); ?> value="ticket-list"><?php esc_attr_e( 'Lista de ocorrências', 'supportcandy' ); ?></option>
						<option <?php selected( $tab, 'new-ticket' ); ?> value="new-ticket"><?php esc_attr_e( 'New ticket', 'supportcandy' ); ?></option>
					</select>
				</div>
				<div class="wpsc-tff wpsc-xs-12 wpsc-sm-12 wpsc-md-12 wpsc-lg-12">
					<div class="submit-container">
						<button class="wpsc-button normal primary" onclick="wpsc_set_agent_settings(this, '<?php echo esc_attr( wp_create_nonce( 'wpsc_set_agent_settings' ) ); ?>');"><?php esc_attr_e( 'Salvar mudanças', 'supportcandy' ); ?></button>
					</div>
				</div>
			...
			<div class="wpsc-exceptions-container" style="padding: 15px !important;">
				...
				<script>
					...
					jQuery('table.<?php echo esc_attr( $unique_id ); ?>').DataTable({
						...
						buttons: [
							{
								text: '<?php echo esc_attr( wpsc__(' Adicionar novo', 'supportcandy' ) ); ?>',
			...
			<form action="#" onsubmit="return false;" class="wpsc-frm-ap-holiday-actions">
				...
				<div class="wpsc-input-group">
					...
					<select class="<?php echo esc_attr( $unique_id ); ?>" name="holiday-action">
						<option value="add"><?php esc_attr_e(' Adicionar novo holidays', 'supportcandy' ); ?></option>
