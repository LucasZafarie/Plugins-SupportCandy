...
if ( ! class_exists( 'WPSC_Current_User' ) ) :
	...
	final class WPSC_Current_User {
		...
		public static function get_user_registration() {
			...
			<h2><?php esc_attr_e( 'Cadastrar', 'supportcandy' ); ?></h2>
			<form onsubmit="return false;" class="wpsc-login wpsc-authenticate-registration">
				<input type="text" name="firstname" placeholder="<?php esc_attr_e( 'Primeiro nome', 'supportcandy' ); ?>" autocomplete="off"/>
				<input type="text" name="lastname" placeholder="<?php esc_attr_e( 'Sobrenome', 'supportcandy' ); ?>" autocomplete="off"/>

				<div style="margin: 0 0 5px !important;">
					<input id="wpsc-username" type="text" name="username" style="margin-bottom: 0px !important;" placeholder="<?php esc_attr_e( 'Nome de usuário', 'supportcandy' ); ?>" autocomplete="off"/>
					<small id="wpsc-username-unavailable" style="color: #e84118;font-style:italic;display:none;"><?php esc_attr_e( 'Nome de usuário em uso!', 'supportcandy' ); ?></small>
					<small id="wpsc-username-available" style="color: #4cd137;font-style:italic;display:none;"><?php esc_attr_e( 'Nome de usuário disponivel!', 'supportcandy' ); ?></small>
					<script>
				...
				<input type="text" name="email_address" placeholder="<?php esc_attr_e( 'Email', 'supportcandy' ); ?>" autocomplete="off"/>
				<input type="password" name="password" placeholder="<?php esc_attr_e( 'Senha', 'supportcandy' ); ?>"/>
				<input type="password" name="confirm_password" placeholder="<?php esc_attr_e( 'Confirme a senha', 'supportcandy' ); ?>"/>
				<?php
					...
					if ( $tc['allow-term-and-conditions-reg-user'] ) :
						...
						<div class="wpsc-tff term-and-conditions wpsc-xs-12 wpsc-sm-12 wpsc-md-12 wpsc-lg-12 required wpsc-visible" data-cft="term-and-conditions-reg-user">
							<div class="checkbox-container">
								...
								?>
								<label for="<?php echo esc_attr( $unique_id ); ?>"><p>Eu concordo com os Termos e Condições</p><?php /*echo wp_kses_post( $name );*/ ?></label>
							</div>
						</div>
						<?php
					endif;
					...
					if ( $gdpr['allow-gdpr-reg-user'] ) {
						...
						<div class="wpsc-tff wpsc-gdpr wpsc-xs-12 wpsc-sm-12 wpsc-md-12 wpsc-lg-12 required wpsc-visible" data-cft="gdpr-reg-user">
							<div class="checkbox-container">
								...
								?>
								<label for="<?php echo esc_attr( $unique_id ); ?>"><p>Entendo que minhas informações pessoais como nome, endereço de e-mail, endereço IP, etc. serão armazenadas no banco de dados.</p><?php /*echo wp_kses_post( $name );*/ ?></label>
							</div>
						</div>
						<?php
					}
				...
				<button class="wpsc-button normal primary" onclick="wpsc_set_default_registration(this)"><?php esc_attr_e( 'Enviar', 'supportcandy' ); ?></button>
				<button class="wpsc-button normal secondary" onclick="window.location.reload();"><?php esc_attr_e( 'Cancelar', 'supportcandy' ); ?></button>
		...
		public static function send_registration_otp() {
			...
			<h2><?php esc_attr_e( 'Cadastrar', 'supportcandy' ); ?></h2>
			<small style="margin: 0 0 5px;"><?php esc_attr_e( 'Enviamos uma senha única de 6 dígitos para o seu endereço de e-mail.', 'supportcandy' ); ?></small>
			<form onsubmit="return false;" class="wpsc-login wpsc-confirm-registration">
				<input type="text" name="otp" autocomplete="off"/>
				<button class="wpsc-button normal primary" onclick="wpsc_confirm_registration(this)"><?php esc_attr_e( 'Enviar', 'supportcandy' ); ?></button>
		...
		public static function registration_email_template_section( $sections ) {
			...
			$sections['registration-otp'] = array(
				...
				'icon'     => 'unlock',
				'label'    => esc_attr__( 'Registro OTP', 'supportcandy' ),
		...
		public static function get_guest_sign_in() {
			...
			<h2><?php esc_attr_e( 'Entrar', 'supportcandy' ); ?></h2>
		...
		public static function get_guest_sign_in_auth() {
			...
			<form onsubmit="return false;" class="wpsc-login wpsc-confirm-guest-login">
				<input type="text" name="otp" autocomplete="off"/>
				<button class="wpsc-button normal primary" onclick="wpsc_confirm_guest_login(this)"><?php esc_attr_e( 'Enviar', 'supportcandy' ); ?></button>
