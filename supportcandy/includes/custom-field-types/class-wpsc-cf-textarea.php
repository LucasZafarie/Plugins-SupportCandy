...
if ( ! class_exists( 'WPSC_CF_Textarea' ) ) :
	...
	final class WPSC_CF_Textarea {
		...
		public static function print_val( $cf, $val ) {
			...
			if ( ! $val ) {
				esc_attr_e( 'Não definido', 'supportcandy' );
				return;
			}
		...
		public static function get_history_log_val( $cf, $val ) {
			...
			return $val ? str_replace( PHP_EOL, '<br/>', esc_html( $val ) ) : esc_attr__( 'Não definido', 'supportcandy' );
		}
		...
		public static function get_field_value( $cf, $val ) {
			...
			return $val ? wp_kses_post( str_replace( PHP_EOL, '<br/>', esc_html( $val ) ) ) : esc_attr__( 'Não definido', 'supportcandy' );
		}
	}
endif;
