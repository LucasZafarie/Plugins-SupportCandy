...
if ( ! class_exists( 'WPSC_CF_URL' ) ) :
	...
	final class WPSC_CF_URL {
		...
		public static function get_history_log_val( $cf, $val ) {
			...
			return $val ? esc_url_raw( $val ) : esc_attr__( 'Não definido', 'supportcandy' );
		}
		...
		public static function get_field_value( $cf, $val ) {
			...
			return $val ? '<a href="' . esc_url_raw( $val ) . '" target="__blank">' . esc_url_raw( $val ) . '</a>' : esc_attr__( 'Não definido', 'supportcandy' );
		}
	}
endif;
