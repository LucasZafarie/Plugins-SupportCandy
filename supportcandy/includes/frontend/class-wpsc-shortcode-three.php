...
if ( ! class_exists( 'WPSC_Shortcode_Three' ) ) :
	...
	final class WPSC_Shortcode_Three {
			...
			<div class="wpsc-auth-container">
				<div class="auth-inner-container">
					...
					<form onsubmit="return false;" class="wpsc-login wpsc-authenticate-open-ticket">
						...
						<button class="wpsc-button normal primary" onclick="wpsc_authenticate_open_ticket(this)"><?php esc_attr_e( 'Enviar', 'supportcandy' ); ?></button>
		...
		public static function get_authenticate_open_ticket() {
			...
			<div class="auth-inner-container">
				<h2><?php esc_attr_e( 'Open existing ticket', 'supportcandy' ); ?></h2>
				<small style="margin: 0 0 5px;"><?php esc_attr_e( 'Enviamos uma senha única de 6 dígitos para o seu endereço de e-mail. Please insert it below and submit to open ticket!', 'supportcandy' ); ?></small>
				<form onsubmit="return false;" class="wpsc-login wpsc-confirm-open-ticket-auth">
					<input type="text" name="otp" autocomplete="off"/>
					<button class="wpsc-button normal primary" onclick="wpsc_confirm_open_ticket_auth(this, '<?php echo esc_attr( wp_create_nonce( 'wpsc_confirm_open_ticket_auth' ) ); ?>')"><?php esc_attr_e( 'Enviar', 'supportcandy' ); ?></button>
