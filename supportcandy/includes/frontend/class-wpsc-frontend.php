		...
		private static function get_localization_data() {
			...
			$localizations = array(
				...
				'translations'            => array(
					...
					'datatables'       => array(
						'emptyTable'     => esc_attr__( 'Nada registrado', 'supportcandy' ),
						'zeroRecords'    => esc_attr__( 'Nada registrado', 'supportcandy' ),
						'info'           => sprintf(
							/* translators: e.g. Showing 1 to 20 of 300 records */
							esc_attr__( 'Mostrando %1$s de %2$s de %3$s registros', 'supportcandy' ),
							'_START_',
							'_END_',
							'_TOTAL_'
						),
						...
						'paginate'       => array(
							'first'    => esc_attr__( 'Primeiro', 'supportcandy' ),
							'previous' => esc_attr__( 'Anterior', 'supportcandy' ),
							'next'     => esc_attr__( 'Próximo', 'supportcandy' ),
							'last'     => esc_attr__( 'Último', 'supportcandy' ),
						),
					),
				),
				'temp'                    => array(),
				...
				<div class="auth-inner-container">
					...
					<form onsubmit="return false;" class="wpsc-login wpsc-default-login">
						...
						if ( $page_settings['user-login'] === 'default' ) {
							...
							<input type="text" name="username" placeholder="Usuário ou email" autocomplete="off"/>
							...
							<div class="checkbox-container remember-me">
								...
								<label for="wpsc-remember-me"><?php esc_attr_e( 'Lembre de mim', 'supportcandy' ); ?></label>
							</div>
							<?php
							...
							<button class="wpsc-button normal primary" onclick="wpsc_submit_login_form(this)">Entrar</button>
							...
							?>
							<button class="wpsc-button normal primary" onclick="wpsc_custom_login( this, '<?php echo esc_url( $login_url ); ?>' )"><?php esc_attr_e( 'Entrar', 'supportcandy' ); ?></button>
							<?php
					...
					<div class="auth-links">
						...
						if ( $page_settings['user-login'] === 'default' ) :
							?>
							<a class="wpsc-link wpsc-forgot-password" href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_attr_e( 'Esqueceu a senha?', 'supportcandy' ); ?></a>
							<?php
						endif;
						...
						if ( $page_settings['user-registration'] !== 'disable' ) {
							?>
							<a class="wpsc-link wpsc-register" href="<?php echo esc_attr( $registration_url ); ?>"><?php esc_attr_e( 'Não tem conta? Criar', 'supportcandy' ); ?></a>
							<?php
						}
						...
						if ( $additional_links && in_array( 'guest', $gs['allow-create-ticket'] ) ) :
							?>
							<a class="wpsc-link wpsc-guest-create-ticket" href="javascript:wpsc_get_guest_ticket_form();"><?php esc_attr_e( 'Continue sem login', 'supportcandy' ); ?></a>
							<?php
						endif;
