...
if ( ! class_exists( 'WPSC_Framework' ) ) :
	...
	final class WPSC_Framework {
		...
		public static function localizations( $localizations ) {
			...
			$localizations['translations']['please_wait']           = esc_attr__( 'Aguarde...', 'supportcandy' );
			$localizations['translations']['req_fields_missing']    = esc_attr__( 'Campos obrigatorios estão vazios!', 'supportcandy' );
			$localizations['translations']['confirm']               = esc_attr__( 'Você tem certeza??', 'supportcandy' );
			$localizations['translations']['something_wrong']       = esc_attr__( 'Ocorreu algum erro!', 'supportcandy' );
			$localizations['translations']['view_more']             = esc_attr__( 'Ver mais!', 'supportcandy' );
			$localizations['translations']['view_less']             = esc_attr__( 'Ver menos!', 'supportcandy' );
			$localizations['translations']['warning_message']       = html_entity_decode( esc_attr__( 'Há texto não postado na área de resposta. Tem certeza de que deseja descartar e prosseguir?', 'supportcandy' ), ENT_QUOTES );
			$localizations['translations']['incorrect_login']       = esc_attr__( 'Senha ou usuário incorreto!', 'supportcandy' );
			$localizations['translations']['incorrect_password']    = esc_attr__( 'Senha incorreta!', 'supportcandy' );
			$localizations['translations']['unsername_unavailable'] = esc_attr__( 'Nome de usuário já em uso!', 'supportcandy' );
			$localizations['translations']['incorrect_email']       = esc_attr__( 'Email incorreto!', 'supportcandy' );
			$localizations['translations']['copy_url']              = esc_attr__( 'Copiado!', 'supportcandy' );
			$localizations['translations']['invalidEmail']          = esc_attr__( 'Email inválido!', 'supportcandy' );
			$localizations['translations']['customer_delete_warn'] = esc_attr__( 'Excluir um cliente removerá permanentemente todas as informações e ocorrências associados do cliente!', 'supportcandy' );
			$localizations['translations']['req_term_cond']           = esc_attr__( 'Por favor, aceite os termos e condições!', 'supportcandy' );
			$localizations['translations']['req_gdpr']           = esc_attr__( 'Aceite a política do GDPR!', 'supportcandy' );
